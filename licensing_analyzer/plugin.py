...
class Plugin(KafkaPluginNonBlocking):
    ...
    def produce(self, in_payload):
        '''
        Produces licensing analysis results to the produce_topics. A separate
        ...
        try:
            ...
            self.emit_message(self.produce_callable_topic, out_message, "[SUCCESS]", out_message)
            self.handle_success(in_payload, "Licensing analysis result produced.")
        except Exception as e:
            self.handle_failure(in_payload, "Licensing analysis failed for payload.", str(e))
