...
class Plugin(KafkaPluginNonBlocking):
    ...
    def __init__(self, name, version, description, plugin_config):
        ...
        self.analyzer = ScanCodeRunner(self.plugin_config.get_config_value('extensions'))
    ...
    def produce(self, in_payload):
        '''
        Produces analyzer results to the produce_topics. A separate
        ...
        '''
        try:
            result_file = self.analyzer.analyze(in_payload['sourcePath'],
